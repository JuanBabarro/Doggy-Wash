...
public class CargaDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BtnGuardar1.setBackground(new java.awt.Color(62, 201, 255));
        BtnGuardar1.setFont(new java.awt.Font("Segoe UI Black", 3, 14)); // NOI18N
        BtnGuardar1.setForeground(new java.awt.Color(0, 0, 0));
        BtnGuardar1.setIcon(new javax.swing.ImageIcon("C:\\Users\\JuanC\\Documents\\NetBeansProjects\\PeluqueriaCanina\\Imagenes\\devolver.png")); // NOI18N
    ...
    private void BtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGuardarActionPerformed
        ...
        if (nombreMaco.isEmpty() || raza.isEmpty() || color.isEmpty() || alergico.isEmpty() || atenEsp.isEmpty() || nombreDuenio.isEmpty() || celDuenio.isEmpty() || observaciones.isEmpty()) {
            ...
            // Guardamos los datos
            control.guardar(nombreMaco, raza, color, observaciones, alergico, atenEsp, nombreDuenio, celDuenio);
